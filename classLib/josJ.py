...
from classLib.coplanars import CPWParameters, CPWRLPath, CPW2CPW
...
class AsymSquid(ComplexBase):
    ...
    def init_primitives(self):
        ...
        self.p_ext_down = Kolbaska(
            down_pad_center, origin + DPoint(0, -pars.sq_dy / 2),
        ...
        self.p_ext_up = Kolbaska(
            up_pad_center, origin + DVector(0, pars.sq_dy / 2),
            pars.contact_pad_width, pars.contact_pad_ext_r
        )
    ...
    def init_half(self, origin, side=-1):
        ...
        up_st_gap = pars.sq_area / (2 * pars.sq_dy)
